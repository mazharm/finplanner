...
const statesData: StateEntry[] = [
  ...
  { stateCode: 'GA', stateName: 'Georgia', incomeRate: 5.39, capitalGainsRate: 5.39, ssTaxExempt: 'yes', stateStandardDeduction: 5_400 },
  ...
  { stateCode: 'IA', stateName: 'Iowa', incomeRate: 3.8, capitalGainsRate: 3.8, ssTaxExempt: 'yes', stateStandardDeduction: 2_210 },
