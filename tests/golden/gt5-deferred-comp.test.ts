 ...
 *   taxOptimized fills $15k std deduction from NQDC; EOY=$505,000
 * - Year 2 (2027): BOY=$505k; after 4%=$525,200; scheduled dist $120k;
 *   EOY=$405,200
 * - Year 3 (2028): BOY=$405,200; after 4%=$421,408; dist $120k; EOY=$301,408
 * - Year 4 (2029): BOY=$301,408; after 4%=$313,464.32; dist $120k; EOY=$193,464.32
 * - Year 5 (2030): BOY=$193,464.32; after 4%=$201,202.89; dist $120k; EOY=$81,202.89
 * - Year 6 (2031): BOY=$81,202.89; after 4%=$84,451.01; dist capped; EOY=$0
 */
...
describe('GT5: Deferred Comp Concentrated Payout', () => {
  ...
  describe('NQDC distributions are ordinary income', () => {
    it('should include NQDC distributions in taxable ordinary income (years 2-5)', () => {
      for (let i = 1; i <= 4; i++) {
        const yr = yearly[i];
        // NQDC distributes $120k as ordinary income; after $15k std deduction,
